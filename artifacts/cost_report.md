...
| Full held-out evaluation (47 tickets + judge, 0 degrades, 0 retries) | 141 | 317,509 | 29,727 | 0.466 |
| **Rebuild subtotal** | ~333 | ~707,000 | ~68,600 | **~1.06** |
...
## Total spent to date: ~$1.40 Bedrock measured across both eras, plus ~$0.15 EC2 and $2.40/month for the parked disk. The rebuild landed at ~$1.06 against its ~$1.4 pre-registered ceiling. The audit rebuild stayed within its ~$1.4 pre-registered ceiling.
